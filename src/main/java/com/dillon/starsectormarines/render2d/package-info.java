 ...
 *           the cell&#8596;screen camera ({@code BattleCamera}), FBO accumulators
 *           ({@code DecalAccumulator}, {@code LightAccumulator}, {@code Light*}),
 ...
 *           Known impurity (deferred): {@code DecalAccumulator} /
 *           {@code LightAccumulator} still import game-data types
 *           ({@code Decal}, {@code SpriteSheetFrames}, {@code TimeOfDay}); the FBO
