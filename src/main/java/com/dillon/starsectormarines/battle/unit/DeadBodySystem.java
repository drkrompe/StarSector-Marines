...
/**
 * Records a {@link DeadBodyComponent} component for every unit that dies — the
...
public final class DeadBodySystem {
    ...
    private final ComponentStore<DeadBodyComponent> bodies;

    public DeadBodySystem(ComponentStore<DeadBodyComponent> bodies) {
        this.bodies = bodies;
    }
    ...
    public void onDeath(DeathEvent event) {
        Entity u = event.unit();
        bodies.add(u.entityId, new DeadBodyComponent(u.type, u.faction, u.deathPoseIdx));
    }
}
