 ...
 * {@link InfantryWeapons#fireShot} as an accuracy multiplier — damage is
 ...
 *
 * <p>{@link #stanceFor(Unit)} is the convenience for callers that don't
 * already know — they read {@link Unit#moveProgress} and let this enum
