...
public enum UnitType {
    ...
    MARINE     ("graphics/battle/marine.png",      "graphics/battle/marine-dead.png",      true,  25f, 2.0f, 2.0f, 0.35f, 1.0f, 24.0f, FrameLayout.WNES_WEAPON_UP, 1.0f),
    /** Generic regular soldier of an aligned faction (e.g., friendly sector navy on a joint op). Stat-equal to MARINE; sprite differs. */
    MARINE_BLUE("graphics/battle/blue-marine.png", "graphics/battle/blue-marine-dead.png", true,  25f, 2.0f, 2.0f, 0.35f, 1.0f, 24.0f, FrameLayout.WNES_WEAPON_UP, 1.0f),
    /** Pirate / opposed-faction regular. Stat-equal to MARINE; sprite differs. Often on the DEFENDER side, occasionally allied. */
    MARINE_RED ("graphics/battle/red-marine.png",  "graphics/battle/red-marine-dead.png",  true,  25f, 2.0f, 2.0f, 0.35f, 1.0f, 24.0f, FrameLayout.WNES_WEAPON_UP, 1.0f),
    ...
    MILITIA    ("graphics/battle/militia.png",     "graphics/battle/militia-dead.png",     true,  15f, 1.5f, 2.0f, 0.22f, 1.2f, 18.0f, FrameLayout.WNES_WEAPON_UP, 1.0f),
    /** Hostile fauna / xeno boarder. Aggressive brawler — high HP, high damage, slightly faster, mid accuracy. */
    ALIEN      ("graphics/battle/alien.png",       "graphics/battle/alien-dead.png",       true,  30f, 3.0f, 2.2f, 0.32f, 1.1f, 22.0f, FrameLayout.WNES_WEAPON_UP, 1.0f),
    ...
    HEAVY_MECH ("graphics/battle/heavy-mech.png",  "graphics/battle/heavy-mech-dead.png",  true,  90f, 4.0f, 1.4f, 0.40f, 0.6f, 40.0f, FrameLayout.EIGHT_WAY_NO_WEAPON_UP, 1.6f),
    ...
    CIVILIAN   ("graphics/battle/civilian.png",    null,                                   false,  8f, 0f,   2.4f, 0f,    1f,   0f,    FrameLayout.WNES_WEAPON_UP, 1.0f),
    /** Maintenance / industrial worker. Same role as civilian — wanders, flees. */
    ENGINEER   ("graphics/battle/engineer.png",    null,                                   false, 10f, 0f,   2.2f, 0f,    1f,   0f,    FrameLayout.WNES_WEAPON_UP, 1.0f),
    /** Lab tech. Same role as civilian — wanders, flees. Lower HP than engineer; same speed. */
    SCIENTIST  ("graphics/battle/scientist.png",   null,                                   false,  8f, 0f,   2.2f, 0f,    1f,   0f,    FrameLayout.WNES_WEAPON_UP, 1.0f),
    ...
    TURRET     ("",                                null,                                   true,   0f, 0f,   0f,   0f,    1f,   0f,    FrameLayout.WNES_WEAPON_UP, 1.0f);
    ...
    UnitType(String spritePath, String deadSpritePath, boolean combatant,
             ...
             FrameLayout frameLayout, float renderScale) {
