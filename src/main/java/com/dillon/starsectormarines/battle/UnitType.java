...
public enum UnitType {
    ...
    MARINE     ("graphics/battle/marine.png",      "graphics/battle/marine-dead.png",      true,  25f, 2.0f, 2.0f, 0.35f, 1.0f, 24.0f, FrameLayout.WNES_WEAPON_UP, 1.0f, 1.0f),
    /** Generic regular soldier of an aligned faction (e.g., friendly sector navy on a joint op). Stat-equal to MARINE; sprite differs. */
    MARINE_BLUE("graphics/battle/blue-marine.png", "graphics/battle/blue-marine-dead.png", true,  25f, 2.0f, 2.0f, 0.35f, 1.0f, 24.0f, FrameLayout.WNES_WEAPON_UP, 1.0f, 1.0f),
    /** Pirate / opposed-faction regular. Stat-equal to MARINE; sprite differs. Often on the DEFENDER side, occasionally allied. */
    MARINE_RED ("graphics/battle/red-marine.png",  "graphics/battle/red-marine-dead.png",  true,  25f, 2.0f, 2.0f, 0.35f, 1.0f, 24.0f, FrameLayout.WNES_WEAPON_UP, 1.0f, 1.0f),
    ...
    MILITIA    ("graphics/battle/militia.png",     "graphics/battle/militia-dead.png",     true,  15f, 1.5f, 2.0f, 0.22f, 1.2f, 18.0f, FrameLayout.WNES_WEAPON_UP, 1.0f, 0.4f),
    ...
    ALIEN      ("graphics/battle/alien.png",       "graphics/battle/alien-dead.png",       true,  30f, 3.0f, 2.2f, 0.32f, 1.1f, 22.0f, FrameLayout.WNES_WEAPON_UP, 1.0f, 1.2f),
    /** Walker mech with chaingun arms and rocket-pod shoulders. Defender elite that shows up when the target planet has industries producing or demanding heavy armaments (Heavy Industry, Orbital Works, Ground Defenses, Heavy Batteries). High HP, three-weapon chassis loadout ({@link MechLoadoutState}) fired concurrently. Dead sheet has 4 prone hulks; the sim also spawns a {@link com.dillon.starsectormarines.battle.SmokingWreck} on death so the corpse smolders. Renders ~1.6× cell so it visually dominates infantry. Base {@code attackRange} is set to the LRM range so target acquisition reaches across the grid; base {@code attackDamage}/{@code attackCooldown} are unused on mechs (weapons read from {@link MechLoadoutState} instead) but kept non-zero as a defensive fallback. High morale impact — eating fire from a walker mech rattles a squad fast. */
    HEAVY_MECH ("graphics/battle/heavy-mech.png",  "graphics/battle/heavy-mech-dead.png",  true,  90f, 4.0f, 1.4f, 0.40f, 0.6f, 40.0f, FrameLayout.EIGHT_WAY_NO_WEAPON_UP, 1.6f, 1.5f),
    ...
    CIVILIAN   ("graphics/battle/civilian.png",    null,                                   false,  8f, 0f,   2.4f, 0f,    1f,   0f,    FrameLayout.WNES_WEAPON_UP, 1.0f, 1.0f),
    /** Maintenance / industrial worker. Same role as civilian — wanders, flees. */
    ENGINEER   ("graphics/battle/engineer.png",    null,                                   false, 10f, 0f,   2.2f, 0f,    1f,   0f,    FrameLayout.WNES_WEAPON_UP, 1.0f, 1.0f),
