...
public final class CompoundService {
    ...
    /** Compound kinds tracked by this layer. Mirrors {@link com.dillon.starsectormarines.battle.reinforcement.GarrisonDepletedTrigger}'s gate so a kind added here without updating that trigger (or vice versa) flags up at code-review time. */
