...
import com.dillon.starsectormarines.battle.ai.goap.actions.BreachAndAdvance;
...
public final class BreachToEngage implements Goal {
    ...
    private static Unit effectiveTarget(Squad squad, BattleSimulation sim) {
        ...
        return TacticalScoring.findBestTarget(cx, cy, squad.faction, squad.id, null, sim);
    }
