...
public class CompoundPerimeterDefenderStamperTest {
    ...
    /** Compound node anchored at the bbox centroid with a (left, top)-(right, bottom) footprint. defaultGuard = DEFENDER mirrors what {@link com.dillon.starsectormarines.battle.mapgen.bsp.fill.MilitaryBaseFiller} emits. */
