...
| [`narrative/`](narrative/overview.md) | **S1–S4 shipped** | Comms-officer narration with exact-once patron history, two-engagement patterns, bounded local echoes, and confirmed patron-linked Chronicle callbacks. |
