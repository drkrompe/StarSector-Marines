...
| [`loot/`](loot/overview.md) | **active** | Recovery manifest + budget-aware picker are code-complete; cargo settlement is next. Consumes the contract salvage entitlement. Highest user value. |
