...
| [`living-world/`](living-world/overview.md) | **active — A–G2 shipped** | Autonomous politics, Chronicle, civil-war participation/consequences, and two hidden moral-source families. Civilian-rescue trigger/presentation is next. |
