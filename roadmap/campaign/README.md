...
| [`narrative/`](narrative/overview.md) | **S1–S3 shipped** | Comms-officer narration with exact-once patron history, two-engagement patterns, and bounded local cross-patron echoes. |
